export const jobs = [
  {
    ...
    company: 'Appstract',
    companyId: 'appstract',
    body: 'In appstract I developed applications and websites for various clients, including Mundi, Telered, and Kernel. My work involved using different technologies and frameworks such as Ionic, React, and Angular to build dynamic and responsive applications, providing solutions tailored to the specific needs of each client.',
  },
  {
    year: '2023 - 2024',
